...
while index_vdes <= sim_time/delta
    ...
    if v_des == 0
        ...
        out_tot = [out_tot;out1];
        tout_tot = [0:delta:last_index*delta+tout1(end)-delta];
        plot(last_index*delta+tout1,out1(:,1),"Linewidth",3,"Color","#800000");
    ...
    tout_tot = [0:delta:last_index*delta+tout(end)-delta];
    drawnow;
    plot(tout+last_index*delta,out2(:,1),"Linewidth",3,"Color","#800000")
